...
for p in 1 to P:
  build Random Forest model of the p-th variable in X using all other variables (and possibly lags of all variables), call this RF
...
# 3 Applications of analogy weighting

## 3a: An application to estimating core inflation
...
# 3b: An application to portfolio risk management
