...
# Get the model running quickly

# Write a forecaster for the time varying parameter model

# Back-test the three approaches: Regular VAR, TVP VAR, and Analogy Weighted VAR. 

# Impulse response functions for a monetary policy shift at various times. 

# Calculate log of the proximity scores

# Another cool thing to do would be to look at the Volker deflation

# Do everything with realtime data from ALFRED. 
