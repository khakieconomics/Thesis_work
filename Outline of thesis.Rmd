...
Where $\pmb{\eta}$ is iid with a unit diagonal covariance matrix. The covariance matrix is modelled as being the diagonal quadratic form of a scale vector that varies over time $\pmb{\tau_{t}}$ and a correlation matrix that is fixed, $\pmb{\Omega}$. 
