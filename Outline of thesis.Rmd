...
While the channels by which these models transmit shocks vary, their implications for reduced-form modelling are similar: the behaviour of economic agents probably varies across states of the world, and there are potentially many such states. Regime-switching models as in Hamilton (1988) and as reviewed in Kuan (2002) attempt to model changes in  by allowing parameters to vary across (discrete) states. These models typically have a Markov process from which 
...
## A simple multivariate GARCH model and the analogy augmentation
